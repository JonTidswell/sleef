...
int main(int argc, char **argv) {
  ...
  for(;;) {
    ...
    if (startsWith(buf, "sin ")) {
      ...
      printf("%" PRIx64 "\n", u);
    } else if (startsWith(buf, "erfinv_u5 ")) {
      uint64_t u;
      sscanf(buf, "erfinv_u5 %" PRIx64, &u);
      u = d2u(xerfinv_u5(u2d(u)));
      printf("%" PRIx64 "\n", u);
    }
      ...
      printf("%x\n", u);
    } else if (startsWith(buf, "erfinvf_u5 ")) {
      uint32_t u;
      sscanf(buf, "erfinvf_u5 %x", &u);
      u = f2u(xerfinvf_u5(u2f(u)));
      printf("%x\n", u);
    }
