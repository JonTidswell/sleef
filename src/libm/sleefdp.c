...
EXPORT CONST double xerfinv_u4(double x) {
  // Giles erfinv gems
  double t, w, p, r, wc, ws, wt, pc, ps, pt;                                       
  t = (1.0 - x) * (1.0 + x);                                                   
  w = - xlog_u1( t );                        
                                                     
  if ( w < 6.250 ) {                              
    wc = w - 3.1250;                                
    pc =  -3.6444120640178196996e-21;                 
    pc =   -1.685059138182016589e-19 + pc * wc;           
    pc =   1.2858480715256400167e-18 + pc * wc;           
    pc =    1.115787767802518096e-17 + pc * wc;           
    pc =   -1.333171662854620906e-16 + pc * wc;           
    pc =   2.0972767875968561637e-17 + pc * wc;           
    pc =   6.6376381343583238325e-15 + pc * wc;           
    pc =  -4.0545662729752068639e-14 + pc * wc;           
    pc =  -8.1519341976054721522e-14 + pc * wc;           
    pc =   2.6335093153082322977e-12 + pc * wc;           
    pc =  -1.2975133253453532498e-11 + pc * wc;           
    pc =  -5.4154120542946279317e-11 + pc * wc;           
    pc =    1.051212273321532285e-09 + pc * wc;           
    pc =  -4.1126339803469836976e-09 + pc * wc;           
    pc =  -2.9070369957882005086e-08 + pc * wc;           
    pc =   4.2347877827932403518e-07 + pc * wc;           
    ...
    ps =   2.2137376921775787049e-09;                 
    ps =   9.0756561938885390979e-08 + ps * ws;           
    ps =  -2.7517406297064545428e-07 + ps * ws;           
    ps =   1.8239629214389227755e-08 + ps * ws;           
    ps =   1.5027403968909827627e-06 + ps * ws;           
    ps =   -4.013867526981545969e-06 + ps * ws;           
    ps =   2.9234449089955446044e-06 + ps * ws;           
    ps =   1.2475304481671778723e-05 + ps * ws;           
    ps =  -4.7318229009055733981e-05 + ps * ws;           
    ps =   6.8284851459573175448e-05 + ps * ws;           
    ps =   2.4031110387097893999e-05 + ps * ws;           
    ps =   -0.0003550375203628474796 + ps * ws;           
    ps =   0.00095328937973738049703 + ps * ws;           
    ps =   -0.0016882755560235047313 + ps * ws;           
    ...
    wt = xsqrt_u05(w) - 5.0;                          
    pt =  -2.7109920616438573243e-11;                 
    pt =  -2.5556418169965252055e-10 + pt * wt;           
    pt =   1.5076572693500548083e-09 + pt * wt;           
    pt =  -3.7894654401267369937e-09 + pt * wt;           
    pt =   7.6157012080783393804e-09 + pt * wt;           
    pt =  -1.4960026627149240478e-08 + pt * wt;           
    pt =   2.9147953450901080826e-08 + pt * wt;           
    pt =  -6.7711997758452339498e-08 + pt * wt;           
    pt =   2.2900482228026654717e-07 + pt * wt;           
    pt =  -9.9298272942317002539e-07 + pt * wt;           
    pt =   4.5260625972231537039e-06 + pt * wt;           
    pt =  -1.9681778105531670567e-05 + pt * wt;           
